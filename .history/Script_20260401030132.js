...
let isPink = true; 
 ...
 ('click',() => {
  ...
  if (isPink){document.body.classList.add("after-button-clicked"); isPink = false; console.log("changed to blue")} else {document.body.classList.remove("after-button-clicked"); isPink = true;
