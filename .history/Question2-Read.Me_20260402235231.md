...
const programmingLanguages = {
   ...
   language2: { 
    ...
    giveName: function(){return this.langauge1.name;
    },

    giveCreator: function(){return `The creator is ${this.language1.creator}`;
    }
     };
 ```

In this example we created 2 function (methods) inside the object and named them giveName and giveCreator and used a return statement to return the values of the name and creator of langauge1.
