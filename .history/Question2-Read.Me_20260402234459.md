...
In this example we created 2 function (methods) inside the object and named them giveName and giveCreator and used a return statement to return the values of 
