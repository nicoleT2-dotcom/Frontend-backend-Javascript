...
const programmingLanguages = {
  ...
  langauge2: { 
    ...
    giveName: function(){return this langauge.name;}

    giveCreator: (){return `The creator is ${this.language.creator}`;}
    };
 ```

In this example we created 2 function (methods) inside the object and named them giveName and giveCreator and used a return statement to return the values of the name and creator of lan
